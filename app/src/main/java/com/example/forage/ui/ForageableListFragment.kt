...
class ForageableListFragment : Fragment() {
    ...
    private val viewModel: ForageableViewModel by activityViewModels {
        ForageableViewModelFactory(
            (activity?.application as BaseApplication).database.returnForageableDao()
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.forageableList.observe(viewLifecycleOwner, Observer { forageableList ->
            adapter.submitList(forageableList)
        })
